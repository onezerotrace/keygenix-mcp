...
const ADDRESS_DEFAULTS = {
    ...
    SOL: { curve: "ed25519", path: "m/44'/501'/0'/0'", deriveType: "ed25519-hd-key" },
    ...
    SUI_SECP256K1: { curve: "secp256k1", path: "m/54'/784'/0'/0'/0'", deriveType: "bip32" },
    SUI_ED25519: { curve: "ed25519", path: "m/44'/784'/0'/0'/0'", deriveType: "ed25519-hd-key" },
    TON_V3R2: { curve: "ed25519", path: "m/44'/607'/0'", deriveType: "ed25519-hd-key" },
    TON_V4R2: { curve: "ed25519", path: "m/44'/607'/0'", deriveType: "ed25519-hd-key" },
    TON_V5R1: { curve: "ed25519", path: "m/44'/607'/0'", deriveType: "ed25519-hd-key" },
    ADA_ENTERPRISE: { curve: "ed25519", path: "m/1852'/1815'/0'/0/0", deriveType: "bip32-cardano" },
    ...
    SEI: { curve: "secp256k1", path: "m/44'/118'/0'/0/0", deriveType: "bip32" },
    ZEC_P2PKH: { curve: "secp256k1", path: "m/44'/133'/0'/0/0", deriveType: "bip32" },
};
// ─── Handlers ─────────────────────────────────────────────────────────────────
export async function handleListAddresses(config, args) {
